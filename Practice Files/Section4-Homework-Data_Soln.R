...
#Matrix
FreeThrows_Attempt <- rbind(KobeBryant_FTA,JoeJohnson_FTA,LeBronJames_FTA,CarmeloAnthony_FTA,DwightHoward_FTA,ChrisBosh_FTA,ChrisPaul_FTA,KevinDurant_FTA,DerrickRose_FTA,DwayneWade_FTA)
...
colnames(FreeThrows_Attempt)<-Seasons
rownames(FreeThrows_Attempt)<-Players
...
myplot(FreeThrows_Attempt/Games)

#Accuracy of Free Throws
myplot(FreeThrows/FreeThrows_Attempt)
